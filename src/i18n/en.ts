...
export const en: TranslationDictionary = {
  ...
  services: {
    ...
    plans: [
      {
        name: "Landing",
        tagline: "One page, simple and fast.",
        description:
      ...
      {
        name: "Landing+",
        tagline: "A complete page, ready to be found and contacted.",
        description:
          "Ideal for those who want a complete landing page, with basic SEO and a contact form.",
        price: "150",
        currency: "€",
        features: [
          "1 page",
      ...
      },
      {
        ...
        description: "For growing businesses that need more pages and functionality.",
        price: "500",
        currency: "€",
        features: [
          "4-5 pages",
