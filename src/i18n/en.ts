...
export const en: TranslationDictionary = {
  ...
  services: {
    ...
    description: "Choose the right package for your business website.",
    plans: [
      {
        name: "Landing",
        tagline: "A simple presentation page.",
        description: "One page, simple, fast and professional.",
        priceLabel: "",
        price: "100",
        currency: "€",
        features: [
      ...
      {
        name: "Starter",
        tagline: "The complete choice for small businesses.",
        description: "Everything a small business needs to be found online.",
        priceLabel: "",
        price: "250",
        currency: "€",
        features: [
      ...
      {
        name: "Business",
        tagline: "An upgrade for more advanced needs.",
        description: "For businesses that want more than just a website.",
        priceLabel: "",
        price: "500",
        currency: "€",
        features: [
      ...
      {
        name: "Custom",
        tagline: "Fully custom solutions.",
        description: "For projects that need a solution built entirely around the business.",
        priceLabel: "from",
        price: "700",
        currency: "€",
        features: [
    ...
    maintenance: {
      ...
      priceValue: "30",
      priceSuffix: "€/month",
      description: "Your website is live. We make sure it stays updated, fast and functional.",
      features: [
        "Backups",
        "Technical updates",
        "Monitoring",
