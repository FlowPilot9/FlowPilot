...
export const ro: TranslationDictionary = {
  ...
  services: {
    ...
    plans: [
      {
        name: "Landing",
        tagline: "O pagină simplă de prezentare.",
        description: "O prezență online simplă, rapidă și profesionistă.",
        priceLabel: "",
        price: "100",
        currency: "€",
        features: [
      ...
      {
        name: "Starter",
        tagline: "Alegerea completă pentru afaceri mici.",
        description: "Tot ce are nevoie o afacere mică pentru a fi găsită online.",
        priceLabel: "",
        price: "250",
        currency: "€",
        features: [
      ...
      {
        name: "Business",
        tagline: "Upgrade pentru nevoi mai avansate.",
        description: "Pentru afaceri care vor mai mult decât un simplu website.",
        priceLabel: "",
        price: "500",
        currency: "€",
        features: [
      ...
      {
        name: "Custom",
        tagline: "Soluții complet personalizate.",
        description:
          "Pentru proiecte care au nevoie de o soluție construită complet în jurul business-ului.",
        priceLabel: "de la",
        price: "700",
        currency: "€",
        features: [
          "Arhitectură complet personalizată",
          "Funcționalități complexe",
          "Integrări avansate",
          "CMS / administrare conținut",
          "Automatizări",
          "Soluții web custom",
          "Scalare și dezvoltare ulterioară",
        ],
        cta: "Discută cu noi",
      },
    ],
    maintenance: {
      ...
      priceSuffix: "€/lună",
      description:
        "Site-ul tău este lansat. Noi ne asigurăm că rămâne actualizat, rapid și funcțional.",
      features: [
        "Backup-uri",
        "Actualizări tehnice",
        "Monitorizare",
