    ...
    items: [
      {
        ...
        tag: "HoReCa",
        description: "Site elegant pentru restaurante, cu meniu digital, rezervări și galerie foto.",
      ...
      },
      {
        ...
        tag: "Industrial",
        description: "Prezență solidă pentru companii de construcții, cu portofoliu de proiecte și oferte rapide.",
        stack: ["React", "Next.js", "CMS"],
        isLive: false,
      },
      {
        ...
        tag: "Profesional",
        description: "Site de încredere pentru cabinete de avocatură, cu arii de practică și programare consultații.",
        stack: ["React", "Next.js", "CMS"],
        isLive: false,
      },
      {
        ...
        tag: "Lifestyle",
        description: "Landing page dinamică pentru studiouri fitness, cu clase, abonamente și înscriere online.",
        stack: ["React", "Next.js", "CMS"],
        isLive: false,
      },
    ],
