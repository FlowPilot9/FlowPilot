...
const showcaseUrls = [undefined, "https://aurora-dental-rosy.vercel.app/", undefined, undefined, undefined] as const;
            ...
            return (
              <div key={product.title} className="group flex flex-col">
                ...
                <div className="mt-5 flex flex-1 flex-col px-1">
                  ...
                  <h3 className="mt-1.5 text-base font-semibold text-foreground">{product.title}</h3>
