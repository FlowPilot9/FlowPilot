            ...
            >
              ...
              <div className="mt-8 grid grid-cols-1 gap-8 sm:grid-cols-3">
                <div>
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-muted-foreground">{activeStep.whatWeDo}</p>
                </div>
                <div>
                  <div className="text-xs font-semibold uppercase tracking-[0.1em] text-foreground">
                    {t.process.labels.whatClientGets}
                  </div>
                  <p className="mt-2 text-sm leading-relaxed text-muted-foreground">{activeStep.whatClientGets}</p>
                </div>
                <div>
                  <div className="text-xs font-semibold uppercase tracking-[0.1em] text-foreground">
                    {t.process.labels.whyItMatters}
                  </div>
                  <p className="mt-2 text-sm leading-relaxed text-muted-foreground">{activeStep.whyItMatters}</p>
                </div>
              </div>
            </motion.div>
          </AnimatePresence>
