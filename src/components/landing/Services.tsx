...
function AutomationPreview() {
  return (
    <svg viewBox="0 0 140 40" className="h-10 w-full" aria-hidden>
      ...
      />
      <circle cx="12" cy="20" r="5" className="fill-muted-foreground/25 transition-colors duration-300 group-hover:fill-primary" />
      <circle cx="70" cy="20" r="5" className="fill-muted-foreground/25 transition-colors delay-150 duration-300 group-hover:fill-primary" />
      <circle cx="128" cy="20" r="5" className="fill-muted-foreground/25 transition-colors delay-300 duration-300 group-hover:fill-primary" />
    </svg>
  );
}
...
function GrowthPreview() {
  return (
    <svg viewBox="0 0 140 40" className="h-10 w-full" aria-hidden>
      ...
      />
      <circle cx="136" cy="6" r="3" className="fill-muted-foreground/30 transition-colors duration-300 group-hover:fill-primary" />
    </svg>
  );
}
